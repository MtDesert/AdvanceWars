...
Terrains={
	...
	--生产与修复单位的地形
	{name="City",translate="城市",defendLV=3,capturable=true,hasIncome=true,note="战争中的主要经济来源,兵家必争之地",repairType="LandForce"},
	{name="AirPort",translate="临时机场",defendLV=1,capturable=true,note="临时建造的据点,主要用于飞机的补给和修复",repairType="AirForce"},
	{name="ShipPort",translate="临时港口",defendLV=1,capturable=true,note="临时建造的据点,主要用于船只的补给和修复",repairType="NavyForce"},
	{name="Factory",translate="工厂",defendLV=3,capturable=true,hasIncome=true,note="用于生产,补给,修复陆军的据点,一般来说重要性比城市高",produceType="LandForce"},
